...
const katakanaWords = [
    ...
    { japanese: "サッカー", latin: "Sa(tsu)kkaa (Soccer)" },
    { japanese: "カヌー", latin: "Kanuu (Kano)" },
    { japanese: "チェス", latin: "Chiesu (Chess)" },
    { japanese: "テニス", latin: "Tenisu (Tennis)" },
    { japanese: "アイドル", latin: "Aidoru (Idol)" },
    { japanese: "ビデオ", latin: "Bideo (Video)" },
    { japanese: "ワイン", latin: "Wain (Wine)" },
    { japanese: "フライドポテト", latin: "Furaido poteto (Fried Potato)" },
    { japanese: "クリスマス", latin: "Kurisumasu (Christmas)" },
    { japanese: "ロシア", latin: "Roshia (Russia)" },
    { japanese: "パナマ", latin: "Panama" },
    { japanese: "ノルウェー", latin: "Noruuee (Norway)" },
    { japanese: "ソニー", latin: "Sonii (Sony)" },
    { japanese: "コンビニ", latin: "Konbini (Convenience (store))" },
    { japanese: "ナミビア", latin: "Namibia" },
    { japanese: "ネクタイ", latin: "Nekutai (Necktie)" },
    { japanese: "ヨーロッパ", latin: "Yooro(tsu)ppa (Europe)" },
    { japanese: "ニュージーランド", latin: "Nyuujiirando (New Zealand)" },
];
